...
public class FrontClimber extends Subsystem {
    ...
    frontClimberTalon.setSelectedSensorPosition(0);
    }
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber("Front Climber Enc Value", getFrontClimberEncValue());
    ...
    public int getFrontClimberEncValue(){
        int frontEncValue = frontClimberTalon.getSensorCollection().getQuadraturePosition();
        return (frontEncValue);
    }
