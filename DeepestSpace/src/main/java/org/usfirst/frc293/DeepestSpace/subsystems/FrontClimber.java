...
public class FrontClimber extends Subsystem {
    ...
    private Encoder frontClimberEncoder;
    ...
    public FrontClimber() {
        ...
        frontClimberTalon = new WPI_TalonSRX(20);
        
        
        
        frontClimberEncoder = new Encoder(3, 4, false, EncodingType.k4X);
        addChild("FrontClimberEncoder",frontClimberEncoder);
        frontClimberEncoder.setDistancePerPulse(1.0);
        frontClimberEncoder.setPIDSourceType(PIDSourceType.kRate);
