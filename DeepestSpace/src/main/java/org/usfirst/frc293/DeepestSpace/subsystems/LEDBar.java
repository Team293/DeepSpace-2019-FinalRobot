...
public class LEDBar extends Subsystem {
    ...
    public void greenOn(boolean state){
        greenOutput.set(state);
    }
    public void blueOn(boolean state){
        blueOutput.set(state);
    }
     // LED Logic
    ...
    public void setAutopilotEnable (boolean autopilotEnabled){
        autopilotEnable = autopilotEnabled;
        LEDlogic();
    }
}