...
public class Elevator extends Subsystem {
    ...
    public void ground(){
        ...
        lowScrewPID.setReference(groundSet[0], ControlType.kPosition);
        highScrewPID.setReference(groundSet[1],ControlType.kPosition);
    }
    public void lowHatch(){
        if(elevatorPiston.get() == Value.kOff || elevatorPiston.get() == Value.kForward){
            elevatorDown();
        }
        lowScrewPID.setReference(lowHatchSet[0], ControlType.kPosition);
        highScrewPID.setReference(lowHatchSet[1],ControlType.kPosition);
    }
    public void lowCargo(){
        if(elevatorPiston.get() == Value.kOff || elevatorPiston.get() == Value.kForward){
            elevatorDown();
        }
        lowScrewPID.setReference(lowCargoSet[0], ControlType.kPosition);
        highScrewPID.setReference(lowCargoSet[1],ControlType.kPosition);
    }
    public void midHatch(){
        if(elevatorPiston.get() == Value.kOff || elevatorPiston.get() == Value.kForward){
            elevatorDown();
        }
        lowScrewPID.setReference(midHatchSet[0], ControlType.kPosition);
        highScrewPID.setReference(midHatchSet[1],ControlType.kPosition);
    }
    public void midCargo(){
        if(elevatorPiston.get() == Value.kOff || elevatorPiston.get() == Value.kForward){
            elevatorDown();
        }
        lowScrewPID.setReference(midCargoSet[0], ControlType.kPosition);
        highScrewPID.setReference(midCargoSet[1],ControlType.kPosition);
    }
    public void highHatch(){
        if(elevatorPiston.get() == Value.kOff || elevatorPiston.get() == Value.kReverse){
            elevatorUp();
        }
        lowScrewPID.setReference(highHatchSet[0], ControlType.kPosition);
        highScrewPID.setReference(highHatchSet[1],ControlType.kPosition);
    }
    public void highCargo(){
        if(elevatorPiston.get() == Value.kOff || elevatorPiston.get() == Value.kReverse){
            elevatorUp();
        }
        lowScrewPID.setReference(highCargoSet[0], ControlType.kPosition);
        highScrewPID.setReference(highCargoSet[1],ControlType.kPosition);
    }
}
