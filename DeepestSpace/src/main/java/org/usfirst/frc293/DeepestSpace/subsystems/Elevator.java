...
public class Elevator extends Subsystem {
    ...
    public void periodic() {
       ...
       if(upperScrewTalon.getSensorCollection().isFwdLimitSwitchClosed()){
        ...
        // Manual PID (This is an oxymoron)
        if(Robot.oi.getOpRightJoy().getRawButton(6)){
            lowerScrewTalon.set(ControlMode.Position,(lowerScrewTalon.getClosedLoopTarget() + mIncrement));
        }
        else if(Robot.oi.getOpRightJoy().getRawButton(4)){
            lowerScrewTalon.set(ControlMode.Position,(lowerScrewTalon.getClosedLoopTarget() - mIncrement));
        }

        if(Robot.oi.getOpRightJoy().getRawButton(5)){
            upperScrewTalon.set(ControlMode.Position,(upperScrewTalon.getClosedLoopTarget() + mIncrement));
        }
        else if(Robot.oi.getOpRightJoy().getRawButton(3)){
            upperScrewTalon.set(ControlMode.Position,(upperScrewTalon.getClosedLoopTarget() - mIncrement));
        }
