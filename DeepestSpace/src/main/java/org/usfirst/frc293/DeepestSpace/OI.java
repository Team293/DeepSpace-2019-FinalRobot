...
*/
    ...
    public JoystickButton hab2ClimbB;
    public JoystickButton hab3ClimbB;
    ...
    public OI() {
        ...
        hab3ClimbB = new JoystickButton(opRightJoy, 10);
        hab3ClimbB.whenPressed(new Hab3Climb());
        hab2ClimbB = new JoystickButton(opRightJoy, 9);
        hab2ClimbB.whenPressed(new Hab2Climb());
        ...
        climberBackwardB = new JoystickButton(opLeftJoy, 8);
        climberBackwardB.whileHeld(new ClimberBackward());
        climberForwardB = new JoystickButton(opLeftJoy, 7);
        ...
        SmartDashboard.putData("ArmToAngle", new ArmToAngle());
        ...
        SmartDashboard.putData("BothClimbersDeploy", new BothClimbersDeploy());
        SmartDashboard.putData("Hab2Climb", new Hab2Climb());
        SmartDashboard.putData("Hab3Climb", new Hab3Climb());
