...
public class OI {
    ...
    public JoystickButton stiltsUp;
    public JoystickButton climberForwardB;
    public JoystickButton frontStiltsDownB;
    public JoystickButton backStiltsDownB;
    ...
    public OI() {
        ...
        armUpButton = new JoystickButton(opRightJoy, 1);
        armUpButton.whileHeld(new ArmToAngle(20f));
        ...
        backStiltsDownB = new JoystickButton(opLeftJoy, 4);
        backStiltsDownB.whileHeld(new BackStiltsDown());
        frontStiltsDownB = new JoystickButton(opLeftJoy, 3);
        frontStiltsDownB.whileHeld(new FrontStiltsDown());
        climberForwardB = new JoystickButton(opLeftJoy, 1);
        climberForwardB.whileHeld(new ClimberForward());
        stiltsUp = new JoystickButton(opLeftJoy, 5);
        stiltsUp.whenPressed(new FrontStiltsUp());
    ...
    stiltsUp.whenPressed(new BackStiltsUp());
    }
