...
*/
    ...
    public OI() {
        ...
        moveBottomUpB = new JoystickButton(opLeftJoy, 5);
        moveBottomUpB.whileHeld(new MoveBottomUp());
        moveBottomDownB = new JoystickButton(opLeftJoy, 3);
        moveBottomDownB.whileHeld(new MoveBottomDown());
        moveTopDownB = new JoystickButton(opLeftJoy, 4);
        moveTopDownB.whileHeld(new MoveTopUp());
        moveTopUpB = new JoystickButton(opLeftJoy, 6);
