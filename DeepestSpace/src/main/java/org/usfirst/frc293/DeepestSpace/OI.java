...
*/
    ...
    public OI() {
        ...
        highHatchB = new JoystickButton(buttonBoard, 1);
        highHatchB.whenPressed(new MoveElevator("HighHatch"));
        midHatchB = new JoystickButton(buttonBoard, 3);
        midHatchB.whenPressed(new MoveElevator("MidHatch"));
        lowHatchB = new JoystickButton(buttonBoard, 5);
        lowHatchB.whenPressed(new MoveElevator("LowHatch"));
        highCargoB = new JoystickButton(buttonBoard, 2);
        highCargoB.whenPressed(new MoveElevator("HighCargo"));
        midCargoB = new JoystickButton(buttonBoard, 4);
        midCargoB.whenPressed(new MoveElevator("MidCargo"));
        lowCargoB = new JoystickButton(buttonBoard, 6);
