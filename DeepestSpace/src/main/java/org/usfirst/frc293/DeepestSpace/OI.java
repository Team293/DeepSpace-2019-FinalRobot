...
*/
    ...
    public OI() {
        ...
        moveBottomUpB = new JoystickButton(opRightJoy, 9);
        ...
        moveTopDownB = new JoystickButton(opRightJoy, 12);
        ...
        moveElevHighCargo.whileHeld(new MoveElevator(""));
        moveElevHighHatch = new JoystickButton(opLeftJoy, 7);
        moveElevHighHatch.whileHeld(new MoveElevator(""));
        moveElevMidCargo = new JoystickButton(opLeftJoy, 10);
        moveElevMidCargo.whileHeld(new MoveElevator(""));
        moveElevMidHatch = new JoystickButton(opLeftJoy, 9);
        moveElevMidHatch.whileHeld(new MoveElevator(""));
        ...
        moveElevStow.whenPressed(new MoveElevator("LowHatch"));
        ...
        SmartDashboard.putData("HomeElevUp", new HomeElevUp());
