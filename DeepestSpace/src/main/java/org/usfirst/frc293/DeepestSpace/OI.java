...
*/
    ...
    public JoystickButton bothClimbersDeployB;
    ...
    public OI() {
        ...
        bothClimbersDeployB = new JoystickButton(opRightJoy, 9);
        bothClimbersDeployB.whileHeld(new BothClimbersDeploy());
        ...
        SmartDashboard.putData("ClimbHab3", new ClimbHab3());
