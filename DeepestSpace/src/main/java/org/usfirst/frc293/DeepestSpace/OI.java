...
*/
    ...
    public OI() {
        ...
        moveElevHighCargo.whenPressed(new MoveElevator("HighCargo"));
        moveElevHighHatch = new JoystickButton(opRightJoy, 12);
        moveElevHighHatch.whenPressed(new MoveElevator("HighHatch"));
        moveElevMidCargo = new JoystickButton(opRightJoy, 9);
        moveElevMidCargo.whenPressed(new MoveElevator("MidCargo"));
        moveElevMidHatch = new JoystickButton(opRightJoy, 10);
        moveElevMidHatch.whenPressed(new MoveElevator("MidHatch"));
